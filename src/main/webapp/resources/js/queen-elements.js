			...
			steps: [
				{
					...
					content: "Minified button toggle, provides <strong>more space</strong> for main content",
					placement: "right"
				},
				{
					element: "#tour-left-widget",
					title: "Report Status",
					content: "<i class='icon ion-alert-circled text-warning'></i> Check your report progress here",
					placement: "right"
				},
				{
